...
. Cloud Foundry CLI link:https://github.com/cloudfoundry/cli/releases
. Curl
. Pivotal Web Services Account. Create a free trial account here link:http://run.pivotal.io/ 
